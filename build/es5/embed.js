...
docReady(function () {
    (function (window, document, version, callback) {
        ...
        $.when($.getScript(easyXDMUri), $.getScript(json2Uri)).done(function () {
        ...
        function app(element, isHomeDomain, isOnlyInstance) {
            ...
            $(document).on('fullscreenchange webkitfullscreenchange mozfullscreenchange MSFullscreenChange', function (e) {
                if (e.type === 'webkitfullscreenchange' && !document.webkitIsFullScreen || e.type === 'mozfullscreenchange' && !document.mozFullScreen || e.type === 'MSFullscreenChange' && document.msFullscreenElement === null) {
            ...
            function getOffset() {
                ...
                if (!$offsetParent.is(':root') && !$offsetParent.is('body')) {
            ...
            function createSocket() {
                ...
                var uri = appUri + "?isHomeDomain=" + isHomeDomain + "&isOnlyInstance=" + isOnlyInstance + "&manifestUri=" + manifestUri + "&embedScriptUri=" + absScriptUri + "&embedDomain=" + document.domain + "&domain=" + domain + "&isLightbox=" + isLightbox + "&locale=" + locale;
